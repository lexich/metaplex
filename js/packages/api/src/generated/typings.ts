...
declare global {
  interface NexusGenCustomInputMethods<TypeName extends string> {
    pubkey<FieldName extends string>(fieldName: FieldName, opts?: core.CommonInputFieldConfig<TypeName, FieldName>): void // "PublicKey";
    /**
     * GraphQL representation of BigNumber
     */
    bn<FieldName extends string>(fieldName: FieldName, opts?: core.CommonInputFieldConfig<TypeName, FieldName>): void // "BN";
    buffer<FieldName extends string>(fieldName: FieldName, opts?: core.CommonInputFieldConfig<TypeName, FieldName>): void // "Buffer";
    uint8<FieldName extends string>(fieldName: FieldName, opts?: core.CommonInputFieldConfig<TypeName, FieldName>): void // "Uint8Array";
  }
}
declare global {
  interface NexusGenCustomOutputMethods<TypeName extends string> {
    pubkey<FieldName extends string>(fieldName: FieldName, ...opts: core.ScalarOutSpread<TypeName, FieldName>): void // "PublicKey";
    /**
     * GraphQL representation of BigNumber
     */
    bn<FieldName extends string>(fieldName: FieldName, ...opts: core.ScalarOutSpread<TypeName, FieldName>): void // "BN";
    buffer<FieldName extends string>(fieldName: FieldName, ...opts: core.ScalarOutSpread<TypeName, FieldName>): void // "Buffer";
    uint8<FieldName extends string>(fieldName: FieldName, ...opts: core.ScalarOutSpread<TypeName, FieldName>): void // "Uint8Array";
  }
}
...
export interface NexusGenObjects {
  ...
  AccountWithAuctionData: { // root type
  ...
  ParsedAccount: { // root type
    account?: NexusGenRootTypes['Account'] | null; // Account
    pubkey?: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  ParticipationConfigV2: { // root type
...
export interface NexusGenUnions {
  MasterEdition: NexusGenRootTypes['MasterEditionV1'] | NexusGenRootTypes['MasterEditionV2'];
}
...
export interface NexusGenFieldTypes {
  ...
  AccountWithAuctionData: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['AuctionData'] | null; // AuctionData
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithAuctionDataExtended: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['AuctionDataExtended'] | null; // AuctionDataExtended
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithAuctionManagerV1: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['AuctionManagerV1'] | null; // AuctionManagerV1
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithAuctionManagerV2: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['AuctionManagerV2'] | null; // AuctionManagerV2
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithBidRedemptionTicket: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['BidRedemptionTicket'] | null; // BidRedemptionTicket
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithBidderMetadata: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['BidderMetadata'] | null; // BidderMetadata
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithBidderPot: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['BidderPot'] | null; // BidderPot
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithEdition: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['Edition'] | null; // Edition
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithMasterEdition: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['MasterEdition'] | null; // MasterEdition
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithMetadata: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['Metadata'] | null; // Metadata
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithPayoutTicket: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['PayoutTicket'] | null; // PayoutTicket
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithPrizeTrackingTicket: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['PrizeTrackingTicket'] | null; // PrizeTrackingTicket
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithSafetyDepositBox: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['SafetyDepositBox'] | null; // SafetyDepositBox
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithSafetyDepositConfig: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['SafetyDepositConfig'] | null; // SafetyDepositConfig
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithStore: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['Store'] | null; // Store
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithVault: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['Vault'] | null; // Vault
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AccountWithWhitelistedCreator: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    info: NexusGenRootTypes['WhitelistedCreator'] | null; // WhitelistedCreator
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  AmountRange: { // field return type
    amount: NexusGenScalars['BN'] | null; // BN
    length: NexusGenScalars['BN'] | null; // BN
  }
  AuctionData: { // field return type
    auctionGap: NexusGenScalars['BN'] | null; // BN
    authority: NexusGenScalars['PublicKey'] | null; // PublicKey
    bidRedemptionKey: NexusGenScalars['PublicKey'] | null; // PublicKey
    bidState: NexusGenRootTypes['BidState'] | null; // BidState
  ...
  AuctionDataExtended: { // field return type
    gapTickSizePercentage: number | null; // Int
    tickSize: NexusGenScalars['BN'] | null; // BN
    totalUncancelledBids: NexusGenScalars['BN'] | null; // BN
  }
  AuctionManagerV1: { // field return type
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
  }
  AuctionManagerV2: { // field return type
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
  }
  ...
  BidRedemptionTicket: { // field return type
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
  }
  BidState: { // field return type
    bids: Array<NexusGenRootTypes['Bid'] | null> | null; // [Bid]
    max: NexusGenScalars['BN'] | null; // BN
    type: NexusGenEnums['BidStateType'] | null; // BidStateType
  }
  BidderMetadata: { // field return type
    auctionPubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
    bidderPubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
    cancelled: boolean | null; // Boolean
    lastBid: NexusGenScalars['BN'] | null; // BN
  ...
  MasterEditionV1: { // field return type
    key: NexusGenEnums['MetadataKey'] | null; // MetadataKey
    maxSupply: NexusGenScalars['BN'] | null; // BN
    oneTimePrintingAuthorizationMint: NexusGenScalars['PublicKey'] | null; // PublicKey
    printingMint: NexusGenScalars['PublicKey'] | null; // PublicKey
  ...
  MasterEditionV2: { // field return type
    key: NexusGenEnums['MetadataKey'] | null; // MetadataKey
    maxSupply: NexusGenScalars['BN'] | null; // BN
    supply: NexusGenScalars['BN'] | null; // BN
  }
  ...
  ParsedAccount: { // field return type
    account: NexusGenRootTypes['Account'] | null; // Account
    pubkey: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  ParticipationConfigV2: { // field return type
    fixedPrice: NexusGenScalars['BN'] | null; // BN
    nonWinningConstraint: NexusGenEnums['NonWinningConstraint'] | null; // NonWinningConstraint
    winnerConstraint: NexusGenEnums['WinningConstraint'] | null; // WinningConstraint
  }
  ParticipationStateV2: { // field return type
    collectedToAcceptPayment: NexusGenScalars['BN'] | null; // BN
  }
  PayoutTicket: { // field return type
    amountPaid: NexusGenScalars['BN'] | null; // BN
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
    recipient: NexusGenScalars['PublicKey'] | null; // PublicKey
  }
  PriceFloor: { // field return type
    hash: NexusGenScalars['Uint8Array'] | null; // Uint8Array
    minPrice: NexusGenScalars['BN'] | null; // BN
    type: NexusGenEnums['PriceFloorType'] | null; // PriceFloorType
  }
  PrizeTrackingTicket: { // field return type
    expectedRedemptions: NexusGenScalars['BN'] | null; // BN
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
    metadata: NexusGenScalars['PublicKey'] | null; // PublicKey
    redemptions: NexusGenScalars['BN'] | null; // BN
  ...
  SafetyDepositBox: { // field return type
    key: NexusGenEnums['VaultKey'] | null; // VaultKey
    order: number | null; // Int
    store: NexusGenScalars['PublicKey'] | null; // PublicKey
    tokenMint: NexusGenScalars['PublicKey'] | null; // PublicKey
  ...
  SafetyDepositConfig: { // field return type
    amountRanges: Array<NexusGenRootTypes['AmountRange'] | null> | null; // [AmountRange]
    amountType: NexusGenEnums['TupleNumericType'] | null; // TupleNumericType
    auctionManager: NexusGenScalars['PublicKey'] | null; // PublicKey
    key: NexusGenEnums['MetaplexKey'] | null; // MetaplexKey
...
export interface NexusGenFieldTypeNames {
  ...
  AccountWithAuctionData: { // field return type name
    account: 'Account'
    info: 'AuctionData'
    pubkey: 'PublicKey'
  }
  AccountWithAuctionDataExtended: { // field return type name
    account: 'Account'
    info: 'AuctionDataExtended'
    pubkey: 'PublicKey'
  }
  AccountWithAuctionManagerV1: { // field return type name
    account: 'Account'
    info: 'AuctionManagerV1'
    pubkey: 'PublicKey'
  }
  AccountWithAuctionManagerV2: { // field return type name
    account: 'Account'
    info: 'AuctionManagerV2'
    pubkey: 'PublicKey'
  }
  AccountWithBidRedemptionTicket: { // field return type name
    account: 'Account'
    info: 'BidRedemptionTicket'
    pubkey: 'PublicKey'
  }
  AccountWithBidderMetadata: { // field return type name
    account: 'Account'
    info: 'BidderMetadata'
    pubkey: 'PublicKey'
  }
  AccountWithBidderPot: { // field return type name
    account: 'Account'
    info: 'BidderPot'
    pubkey: 'PublicKey'
  }
  AccountWithEdition: { // field return type name
    account: 'Account'
    info: 'Edition'
    pubkey: 'PublicKey'
  }
  AccountWithMasterEdition: { // field return type name
    account: 'Account'
    info: 'MasterEdition'
    pubkey: 'PublicKey'
  }
  AccountWithMetadata: { // field return type name
    account: 'Account'
    info: 'Metadata'
    pubkey: 'PublicKey'
  }
  AccountWithPayoutTicket: { // field return type name
    account: 'Account'
    info: 'PayoutTicket'
    pubkey: 'PublicKey'
  }
  AccountWithPrizeTrackingTicket: { // field return type name
    account: 'Account'
    info: 'PrizeTrackingTicket'
    pubkey: 'PublicKey'
  }
  AccountWithSafetyDepositBox: { // field return type name
    account: 'Account'
    info: 'SafetyDepositBox'
    pubkey: 'PublicKey'
  }
  AccountWithSafetyDepositConfig: { // field return type name
    account: 'Account'
    info: 'SafetyDepositConfig'
    pubkey: 'PublicKey'
  }
  AccountWithStore: { // field return type name
    account: 'Account'
    info: 'Store'
    pubkey: 'PublicKey'
  }
  AccountWithVault: { // field return type name
    account: 'Account'
    info: 'Vault'
    pubkey: 'PublicKey'
  }
  AccountWithWhitelistedCreator: { // field return type name
    account: 'Account'
    info: 'WhitelistedCreator'
    pubkey: 'PublicKey'
  }
  AmountRange: { // field return type name
    amount: 'BN'
    length: 'BN'
  }
  AuctionData: { // field return type name
    auctionGap: 'BN'
    authority: 'PublicKey'
  ...
  AuctionDataExtended: { // field return type name
    gapTickSizePercentage: 'Int'
    tickSize: 'BN'
    totalUncancelledBids: 'BN'
  }
  AuctionManagerV1: { // field return type name
    key: 'MetaplexKey'
  }
  AuctionManagerV2: { // field return type name
    key: 'MetaplexKey'
  }
  ...
  BidRedemptionTicket: { // field return type name
    key: 'MetaplexKey'
  }
  BidState: { // field return type name
    bids: 'Bid'
    max: 'BN'
    type: 'BidStateType'
  }
  BidderMetadata: { // field return type name
  ...
  BidderPot: { // field return type name
  ...
  MasterEditionV1: { // field return type name
    key: 'MetadataKey'
    maxSupply: 'BN'
  ...
  MasterEditionV2: { // field return type name
    key: 'MetadataKey'
    maxSupply: 'BN'
    supply: 'BN'
  }
  ...
  ParsedAccount: { // field return type name
    account: 'Account'
    pubkey: 'PublicKey'
  }
  ParticipationConfigV2: { // field return type name
    fixedPrice: 'BN'
    nonWinningConstraint: 'NonWinningConstraint'
    winnerConstraint: 'WinningConstraint'
  }
  ParticipationStateV2: { // field return type name
    collectedToAcceptPayment: 'BN'
  }
  PayoutTicket: { // field return type name
    amountPaid: 'BN'
    key: 'MetaplexKey'
    recipient: 'PublicKey'
  }
  PriceFloor: { // field return type name
    hash: 'Uint8Array'
    minPrice: 'BN'
    type: 'PriceFloorType'
  }
  PrizeTrackingTicket: { // field return type name
  ...
  SafetyDepositBox: { // field return type name
    key: 'VaultKey'
    order: 'Int'
    store: 'PublicKey'
    tokenMint: 'PublicKey'
  ...
  SafetyDepositConfig: { // field return type name
